...
.smart-search .search-icon { position: absolute; left: 13px; top: 50%; transform: translateY(-50%); font-size: 16px; pointer-events: none; }
.smart-search .input { padding-left: 40px; padding-right: 40px; width: 100%; min-width: 0; }
.smart-search .clear-search { position: absolute; right: 8px; top: 50%; transform: translateY(-50%); width: 28px; height: 28px; border: 0; border-radius: 50%; background: transparent; cursor: pointer; color: #718191; font-size: 18px; }
.smart-search .clear-search:hover { background: #edf3f8; color: #315b87; }
...
@media(max-width:700px){ .smart-search{flex-basis:100%;max-width:none}.search-row{align-items:stretch}.search-row .btn{width:auto} table{display:block;overflow-x:auto;white-space:nowrap;} }
</style>
...
>
    <div class="admin-toolbar">
        ...
        <a class="btn" href="<?= e(BASE_URL) ?>?r=admin/student/create">+ Thêm sinh viên</a>
    </div>
    ...
    <div class="card search-card">
        <div class="search-row">
            <div class="smart-search">
                ...
                <input
                    ...
                    data-search-input
                    value="<?= e($q ?? '') ?>"
                    placeholder="Tìm mã SV, họ tên, tài khoản, lớp, khoa..."
                    autocomplete="off"
                >
        ...
        <div style="overflow-x:auto; margin-top:14px;">
            <table>
                ...
                <tbody data-search-body>
                    <?php if (empty($rows)): ?>
                        <tr><td colspan="8" class="empty-row">Không tìm thấy sinh viên phù hợp.</td></tr>
                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <div class="action-row">
                                        <a class="icon-btn" title="Sửa" aria-label="Sửa" href="<?= e(BASE_URL) ?>?r=admin/student/edit&id=<?= (int)$r['user_id'] ?>">✎</a>
                                        <form method="post" action="<?= e(BASE_URL) ?>?r=admin/student/delete" onsubmit="return confirm('Bạn có chắc muốn xóa sinh viên này?');">
        ...
        <div class="pagination" data-search-pagination>
            <?php for ($i = 1; $i <= ($pages ?? 1); $i++): ?>
                <a class="<?= $i === ($page ?? 1) ? 'active' : '' ?>" href="<?= e(BASE_URL) ?>?r=admin/students&q=<?= urlencode($q ?? '') ?>&page=<?= $i ?>"><?= $i ?></a>
            <?php endfor; ?>
        </div>
    </div>
</div>
